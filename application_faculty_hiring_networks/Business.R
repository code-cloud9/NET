...
etas_reslt$sigma_square_21  # reject linear part degenerate when testing reciprocity effect
etas_reslt$sigma_square_51  # reject linear part degenerate when testing sender-receiver effect
